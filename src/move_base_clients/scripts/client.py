...
if __name__ == '__main__':
    ...
    try:
        ...
        for i in range(goal_target.shape[0]):
            move_base_action_client(goal_target[i,0],goal_target[i,1],goal_target[i,2])
            rospy.loginfo("Finish goal %d", i)
